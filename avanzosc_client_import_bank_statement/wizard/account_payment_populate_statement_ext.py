    ...
    def populate_statement(self, cr, uid, ids, context=None):
        ...
        for line in line_obj.browse(cr, uid, line_ids, context=context):
            ...
            if line.move_line_id:
                ...
                if line.account_id.parent_id.code == '4300' or line.account_id.parent_id.code == '430' or line.account_id.parent_id.code == '43':
                    type = 'customer'
                elif line.account_id.parent_id.code == '4000' or line.account_id.parent_id.code == '400' or line.account_id.parent_id.code == '40':
                    type = 'supplier'
                else:
                    type = 'general'                    
