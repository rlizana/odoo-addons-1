...
class purchase_requisition(osv.osv):
    ...
    _columns = {
        ...
        'purchase_order_line_ids': fields.one2many('purchase.order.line', 'purchase_requisition_id', 'Purchase Order Lines'),
    }
                ...
                if not supplierinfo_ids:
                    ...
                    for supplierinfo_id in supplierinfo_ids:
                        ...
                        if not purchase_order_id:
                            ...
                            purchase_id = purchase_order.create(cr, uid, {'origin': origin,
