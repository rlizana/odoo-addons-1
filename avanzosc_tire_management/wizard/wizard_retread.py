...
class wizard_tire_retread (wizard.interface):
    ...
    states = {
            'init': {
                     'actions': [tire_init],
                     'result': {'type': 'form', 'arch':form1, 'fields':form1_fields, 'state': [('end', 'Cancel','gtk-cancel'),('retread', 'Accept','gtk-ok')]}
                    },
            'retread': {
                       'actions' : [],
                       'result': {'type': 'choice', 'next_state': tire_retread}
                     },
            'moved': {
                       'actions' : [],
...
wizard_tire_retread('tire.retread')
