...
class wizard_flatire (wizard.interface):
    ...
    def tireflat (self,cr,uid, data,context):
    ...
    states = {
            'init': {
                     'actions': [tire_init],
                     'result': {'type': 'form', 'arch':form1, 'fields':form1_fields, 'state': [('end', 'Cancel','gtk-cancel'),('tireflat', 'Accept','gtk-ok')]}
                    },
            'tireflat': {
                       'actions' : [],
                       'result': {'type': 'choice', 'next_state': tireflat}
                     },
            'moved': {
                       'actions' : [],
