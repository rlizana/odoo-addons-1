...
class wizard_tire_waste (wizard.interface):
    ...
    def tire_waste (self,cr,uid, data,context):
    ...
    states = {
            ...
            'waste': {
                       'actions' : [],
                       'result': {'type': 'choice', 'next_state': tire_waste}
                     },
            'moved': {
                       'actions' : [],
