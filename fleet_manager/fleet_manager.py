...
class fleet_vehicles(osv.osv):
   ...
   #     return(0.00)
    ...
    _columns = {
                ...
                'pinvoice':fields.many2one('account.invoice','Purchase Invoice',size=15),
...
#   dani def unlink(self, cr, uid, ids):
...
#        return True
    ...
    def _cancel_moves(self,cr,uid,ids,context={}):
       # dani for obj in self.browse(cr, uid, ids):
        #   dani self.pool.get('account.move').unlink(cr,uid,[obj.move_id.id])
