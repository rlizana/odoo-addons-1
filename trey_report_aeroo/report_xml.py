...
class res_company(osv.osv):
    ...
    _columns = {
        ...
        'aero_pdf_convert_command': fields.char('PDF Convert command', size=255, help="Puede ser '/usr/bin/libreoffice --invisible --headless --convert-to pdf:writer_pdf_Export ' o '/opt/libreoffice3.5/program/soffice --invisible --headless --convert-to pdf'"),
    }
    _defaults = {
        'aero_pdf_convert_command': '/usr/bin/libreoffice --invisible --headless --convert-to pdf:writer_pdf_Export ',    
    }
res_company()
