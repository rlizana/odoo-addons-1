...
# Copyright (C) 2012  trey, kilobytes de soluciones
#                                                                       
...
{
    'name': 'Aeroo Reports, modify by trey',
    'version': '1.0',
    'category': 'Generic Modules/Aeroo Reporting',
    'description': """
*** Modify by trey, for convert reports to pdf using command line converter (libreoffice )
...
""",
    'author': 'Equipo de trey | Alistek Ltd, Simone Orsi - Domsense',
    'website': 'http://www.trey.es | http://www.alistek.com',
    'depends': ['base'],
    "init_xml" : [],
