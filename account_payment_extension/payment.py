    ...
    def set_done(self, cr, uid, ids, context=None):
        ...
        for order in self.browse(cr, uid, ids, context):
            ...
            for line in order.line_ids:
                ...
                line_amount = line.type == 'payment' and line.amount or -line.amount
                if line_amount >= 0:
        ...
        for payment_line in self.browse(cr,uid, ids):
            if payment_line.ml_inv_ref:
                values={
                            ...
                            'communication3' : False,
                            'communication4' : False,
                            'communication5' : False,
                            'communication6' : False,
                            'communication7' : False,
                            'communication8' : False,
                            'communication9' : False,
                            'communication10' : False,
                            'communication11' : False,
                            'communication12' : False,
                            'communication13' : False,
                            'communication14' : False,
                            'communication15' : False,
                            'communication16' : False,
                        }
