...
#    Copyright (C) 2011 - 2012 Avanzosc <http://www.avanzosc.es>
#
...
class survey_question_wiz(osv.osv_memory):
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        surv_all_resp_obj.write(cr,uid,[response_id], {'partner_id':partner[0], 'address_id':address[0], 'ref':ref, 'sale_id':sale, 'project_id':project, 'product_id':product, 'picking_id':picking, 'task_id':task, 'production_id':production})
        ###########################################
        #           AvanzOSC CODE(END)            #
        ###########################################
